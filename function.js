...
function checkType (e) {
  ...
  if(filterType == "radio" || filterType == "select"){
...
function saveNewFilter() {
  ...
  if (pid) {
    filterElement.pid = filters[pid].pid;

    console.log(filters, pid, filterElement, "when edit node")
    filters[pid] = filterElement
    console.log(filters, pid, filterElement, "when edit node")
    document.getElementById("j-saveFilter").click()
    modalRebuild()
  } else {
    console.log(filterElement, 'add')
